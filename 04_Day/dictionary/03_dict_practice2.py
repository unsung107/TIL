...
pro-gj
"""
for k in ssafy['classes']['gj'].keys():
    print(ssafy['classes']['gj'][k])
"""
...
"""
for k in ssafy['language']['python']['frameworks'].keys():
    name = ssafy['language']['python']['frameworks'][k]
    print(f'{k}는 {name}이다.')
...
오늘의 당번은 김준호
"""
students = ssafy['classes']['dj']['groups']['E']
print(f'오늘의 당번은 {random.choice(students)}')